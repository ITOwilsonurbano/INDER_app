 ...
 */
public class TypeHandicappedContainer implements Serializable {

    private Integer totalItems = 0;
    private ArrayList<TypeHandicapped> items = new ArrayList<TypeHandicapped>();
    ...
    public ArrayList<TypeHandicapped> getItems() {
        return items;
    }
    public void setItems(ArrayList<TypeHandicapped> items) {
        if (items != null) {
            this.items = items;
        }
    }
    ...
    public TypeHandicappedContainer(Integer totalItems, ArrayList<TypeHandicapped> items, String pagina, String elementos_por_pagina) {
        this.setItems(items);
