 ...
 */
public class SubtypeHandicappedContainer implements Serializable {

    private Integer totalItems = 0;
    private ArrayList<SubtypeHandicapped> items = new ArrayList<SubtypeHandicapped>();
    ...
    public ArrayList<SubtypeHandicapped> getItems() {
        return items;
    }
    public void setItems(ArrayList<SubtypeHandicapped> items) {
        if (items != null) {
            this.items = items;
        }
    }
    ...
    public SubtypeHandicappedContainer(Integer totalItems, ArrayList<SubtypeHandicapped> items, String pagina, String elementos_por_pagina) {
        this.setItems(items);
