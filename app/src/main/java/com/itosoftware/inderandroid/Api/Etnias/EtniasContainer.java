 ...
 */
public class EtniasContainer implements Serializable {

    private Integer totalItems = 0;
    private ArrayList<Etnias> items = new ArrayList<Etnias>();
    ...
    public ArrayList<Etnias> getItems() {
        return items;
    }
    public void setItems(ArrayList<Etnias> items) {
        if (items != null) {
            this.items = items;
        }
    }
    ...
    public EtniasContainer(Integer totalItems, ArrayList<Etnias> items, String pagina, String elementos_por_pagina) {
        this.setItems(items);
