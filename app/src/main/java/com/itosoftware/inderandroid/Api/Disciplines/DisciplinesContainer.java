 ...
 */
public class DisciplinesContainer implements Serializable {

    private Integer totalItems = 0;
    private ArrayList<Disciplines> items = new ArrayList<Disciplines>();
    ...
    public ArrayList<Disciplines> getItems() {
        return items;
    }
    public void setItems(ArrayList<Disciplines> items) {
        if (items != null) {
            this.items = items;
        }
    }
    ...
    public DisciplinesContainer(Integer totalItems, ArrayList<Disciplines> items, String pagina, String elementos_por_pagina) {
        this.setItems(items);
