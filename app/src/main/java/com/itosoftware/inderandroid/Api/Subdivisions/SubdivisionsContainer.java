 ...
 */
public class SubdivisionsContainer implements Serializable {

    private Integer totalItems = 0;
    private ArrayList<Subdivisions> items = new ArrayList<Subdivisions>();
    ...
    public ArrayList<Subdivisions> getItems() {
        return items;
    }
    public void setItems(ArrayList<Subdivisions> items) {
        if (items != null) {
            this.items = items;
        }
    }
    ...
    public SubdivisionsContainer(Integer totalItems, ArrayList<Subdivisions> items, String pagina, String elementos_por_pagina) {
        this.setItems(items);
