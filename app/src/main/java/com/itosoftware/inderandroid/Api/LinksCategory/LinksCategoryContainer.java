 ...
 */
public class LinksCategoryContainer implements Serializable {
    private Integer totalItems = 0;
    private ArrayList<LinksCategory> items = new ArrayList<LinksCategory>();
    ...
    public ArrayList<LinksCategory> getItems() {
        return items;
    }
    public void setItems(ArrayList<LinksCategory> items) {
        if (items != null) {
            this.items = items;
        }
    }
    ...
    public LinksCategoryContainer(Integer totalItems, ArrayList<LinksCategory> items, String pagina, String elementos_por_pagina) {
        this.setItems(items);
