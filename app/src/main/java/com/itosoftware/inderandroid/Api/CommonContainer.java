package com.itosoftware.inderandroid.Api;
 ...
 */
public class CommonContainer implements Serializable {
    ...
    public CommonContainer(Integer totalItems, ArrayList<HashMap> items, String pagina, String elementos_por_pagina) {
        this.setItems(items);
