 ...
 */
public class TownsContainer implements Serializable {

    private Integer totalItems = 0;
    private ArrayList<Towns> items = new ArrayList<Towns>();
    ...
    public ArrayList<Towns> getItems() {
        return items;
    }
    public void setItems(ArrayList<Towns> items) {
        if (items != null) {
            this.items = items;
        }
    }
    ...
    public TownsContainer(Integer totalItems, ArrayList<Towns> items, String pagina, String elementos_por_pagina) {
        this.setItems(items);
