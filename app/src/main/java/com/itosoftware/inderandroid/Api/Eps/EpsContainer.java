 ...
 */
public class EpsContainer implements Serializable {

    private Integer totalItems = 0;
    private ArrayList<Eps> items = new ArrayList<Eps>();
    ...
    public ArrayList<Eps> getItems() {
        return items;
    }
    public void setItems(ArrayList<Eps> items) {
        if (items != null) {
            this.items = items;
        }
    }
    ...
    public EpsContainer(Integer totalItems, ArrayList<Eps> items, String pagina, String elementos_por_pagina) {
        this.setItems(items);
