...
public class SearchAdvancedFragment extends DialogFragment implements AdapterView.OnItemSelectedListener, ZonesListener, CommunesListener, NeighborhoodListener {
    ...
    protected Spinner disciplineSpinner;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_search_advanced, container, false);
        ...
        //General
        general = (EditText) rootView.findViewById(R.id.fragment_search_advanced_general);
        InputMethodManager imm = (InputMethodManager) getActivity().getSystemService(Context.INPUT_METHOD_SERVICE);
        imm.showSoftInput(general, InputMethodManager.SHOW_IMPLICIT);
        String label = callback.getLabel();
        if(label != "Buscar"){
            general.setText(label);
        }

        progress = (ImageView) rootView.findViewById(R.id.fragment_search_advanced_progress_bar);
        ...
        zoneSpinner = (Spinner) rootView.findViewById(R.id.fragment_search_advanced_zone);
        ...
        //Spinner Commune
        communeSpinner = (Spinner) rootView.findViewById(R.id.fragment_search_advanced_commune);
        ...
        neighborhoodSpinner = (Spinner) rootView.findViewById(R.id.fragment_search_advanced_neighborhood);
        ...
        adapterDiscipline = new InderSpinnerAdapter(getActivity(), android.R.layout.simple_spinner_item);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (disciplineSpinner.getSelectedItemPosition() != 0) {
                    Integer code = (Integer) disciplineCodes.get(disciplineSpinner.getSelectedItemPosition());
                    callback.setDiscipline(code.toString());
                } else {
                    Integer code = 0;
                    callback.setDiscipline(code.toString());
                }
                ...
                if (!callback.getDiscipline().equals(null) && !callback.getDiscipline().equals(0)) {
...
//                callback.setDiscipline(disciplineSpinner.getSelectedItem().toString());
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        switch (adapterView.getId()) {
            case R.id.fragment_search_advanced_zone:
                ...
                break;
            case R.id.fragment_search_advanced_commune:
                progress.setVisibility(View.VISIBLE);
                progress.setBackgroundResource(R.drawable.progress_animation);
